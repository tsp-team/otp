    ...
    def __init__(self, doneEvent,
        ...
        self.fsm = ClassicFSM.ClassicFSM(
            ...
            State.State("off",
                        self.enterOff,
                        self.exitOff),
            State.State("version1Adult",
                        self.enterVersion1Adult,
                        self.exitPrivacyPolicy),
            State.State("version1Kids",
                        self.enterVersion1Kids,
                        self.exitPrivacyPolicy),
            State.State("version2Adult",
                        self.enterVersion2Adult,
                        self.exitPrivacyPolicy),
            State.State("version2Kids",
                        self.enterVersion2Kids,
                        self.exitPrivacyPolicy),
            ],
            "off",
            "off",
        ...
        DirectButton(
            ...
            image_scale = (1.75, 1.0, 1.0),
            relief = None,
            text = OTPLocalizer.ActivateChatPrivacyPolicy_Button2A,
            text_scale = textScale,
            text_pos = (0,-0.01),
            textMayChange = 0,
            pos = (0.45, 0.0, 0.4),
            command = self.__handlePrivacyPolicy,
            extraArgs = ["version2Adult"])
        DirectButton(
            buttonFrame,
            image = moreButtonImage,
            image_scale = (1.75, 1.0, 1.0),
            relief = None,
            text = OTPLocalizer.ActivateChatPrivacyPolicy_Button2K,
            text_scale = textScale,
            text_pos = (0,-0.01),
            textMayChange = 0,
            pos = (0.45, 0.0, 0.2),
            command = self.__handlePrivacyPolicy,
            extraArgs = ["version2Kids"])
