...
class NameTumbler(DirectFrame):
    def __init__(self, nameList, category):
        """
        Creates the list of names with the current hilighted choice for
        one category of names (Title, First, Last).
        """
    ...
    #---------------------------------------#
    # Called when the Tumbler is interacted with or altered.
    # Updates nameResult with the new name combo.
    ...
    def getRandomResult(self):
        ...
        # Get Index in Name List to Update Tumbler
