...
Die Mehrheit der großartigen Produkte und Leistungen auf unseren Seiten werden von uns angeboten, ohne dass wir personenbezogene Informationen von Ihnen sammeln. Man kann WDIG-Webseiten besuchen und sich die meisten unserer tollen Inhalte anonym ansehen. Zum Beispiel ist es möglich, sich die Nachrichtenüberschriften unter ABCNEWS.com anzusehen, ohne personenbezogene Informationen anzugeben.

Von Ihnen angegebene Informationen
Es gibt einige wenige Aktivitäten auf unseren Seiten, für die die Angabe personenbezogener Informationen notwendig ist. Zu diesen Aktivitäten gehören Wettbewerbe, Verlosungen, Bezahlvorgänge oder Mitteilungen an uns. Wenn personenbezogene Informationen erfasst werden, dann geschieht das mit Ihrem Wissen, denn Sie müssen dazu ein Formular ausfüllen. Bei den meisten Aktivitäten nehmen wir nur Namen, E-Mail-Adresse, Geburtsdatum, Geschlecht und Postleitzahl auf. Im Falle einer Bezahlung nehmen wir auch Ihre Wohn- und Lieferanschrift auf sowie Ihre Telefonnummer und Kreditkartendaten. Je nachdem, wofür Sie zahlen, müssen wir eventuell auch andere persönliche Daten aufnehmen, zum Beispiel die Bekleidungsgröße.
""","""
Automatisch erfasste Informationen
WDIG-Seiten erfassen einige Informationen über Sie automatisch und es ist daher möglich, dass es für Sie nicht unmittelbar erkennbar ist, dass diese Informationen erfasst werden. Wenn Sie unsere Seite besuchen, wird zum Beispiel Ihre IP-Adresse erfasst, damit wir wissen, wohin wir von Ihnen angeforderte Informationen schicken sollen. Eine IP-Adresse steht oft für die Stelle, von der aus Sie ins Internet gelangen. Das kann zum Beispiel Ihr ISP (Internet Service Provider), Ihr Unternehmen oder Ihre Universität sein. Diese Informationen sind nicht personenbezogen. WDIG-Seiten verwenden automatisch erfasste Informationen dafür, unsere Seiten für Sie interessanter und nützlicher zu gestalten. Dazu gehört, dass wir Werbepartnern auf unserer Seite dabei helfen, Anzeigen zu entwickeln, die unsere Gäste interessieren könnten. Diese Art von Informationen kombinieren wir normalerweise nicht mit personenbezogenen Informationen. Wir werden diese Informationen jedoch mit personenbezogenen Informationen kombinieren, um einen Besucher zu identifizieren, wenn es darum geht, die Einhaltung unserer Hausordnung oder Servicebedingungen zu gewährleisten oder unseren Service, unsere Seite, Gäste oder andere zu schützen.

Was sind Cookies und wie verwendet WDIG sie?
Cookies sind Informationen, die eine Webseite an Ihren Computer schickt, während Sie die Webseite besuchen. Durch diese Informationen kann die Webseite sich wichtige Informationen merken, durch die die Betrachtung der Seite Ihnen mehr Nutzen bringt. WDIG und andere Internet-Unternehmen verwenden Cookies für sehr unterschiedliche Zwecke. Zum Beispiel nutzt DisneyStore.com Cookies, um sich die Artikel in Ihrem Warenkorb zu merken und sie zu verarbeiten, und alle WDIG-Seiten nutzen Cookies, um dafür zu sorgen, dass Kinder keine unmoderierten Chaträume betreten.

Sie können sich von Ihrem Computer warnen lassen, wenn ein Cookie geschickt wird. Sie können auch alle Cookies deaktivieren. Dies stellen Sie über Ihren Browser ein (zum Beispiel Netscape Navigator oder Internet Explorer). Jeder Browser ist ein wenig anders. Schauen Sie daher im Hilfe-Menü Ihres Browsers nach, wie man Cookie-Optionen richtig einstellt. Wenn Sie Cookies deaktivieren (nicht zulassen), dann können Sie viele Features, die Ihren Aufenthalt im Web effizienter gestalten, wie zum Beispiel die oben erwähnten, nicht nutzen und manche unserer Serviceangebote werden nicht richtig funktionieren.
""","""
F2 Wie nutzt WDIG die erfassten personenbezogenen Informationen?

Die Nutzung von personenbezogenen Informationen durch WDIG ist begrenzt: Wir verwenden die Informationen, um Transaktionen auszuführen. Wenn Sie zum Beispiel ein Fantasy Team auf ESPN.com kaufen, verwenden wir Ihre Informationen, um Ihre Bestellung zu bearbeiten. Wenn Sie uns kontaktieren, weil Sie Hilfe benötigen, verwenden wir Ihre Informationen, um Sie zu kontaktieren. Wir verwenden erfasste Informationen, um Sie zu benachrichtigen, wenn Sie bei einem Spiel oder Wettbewerb gewonnen haben. Erfasste Informationen werden verwendet, um Ihnen per E-Mail Updates und Newsletter über unsere Seiten zu schicken. Wir verwenden die von Ihnen zur Verfügung gestellten Informationen auch, um Ihnen per E-Mail WDIG-Produktaktionen und Sonderangebote von Dritten, unseren Partnern, zuzusenden.
""","""
F3 Gibt WDIG Informationen an Unternehmen oder andere Organisationen weiter, die nicht zur Familie der WDIG-Seiten gehören?

Sie sind für uns das Wertvollste, was es gibt. Es gehört nicht zu unserer Geschäftstätigkeit, Informationen über unsere Gäste zu verkaufen. Wenn sich daraus jedoch ein Mehrwert für unsere Gäste ergibt, werden wir Ihre Angaben weitergeben oder Ihnen im Auftrag anderer Unternehmen wie unten beschrieben Mitteilungen zuschicken. Wir geben auch aus Sicherheitsgründen Informationen weiter.
Unternehmen, die "an der Stelle" von WDIG stehen
Zuweilen beauftragen wir Unternehmen, die uns helfen, Produkte oder Dienstleistungen zum Kunden zu bringen, wie zum Beispiel ein Transportunternehmen, das ein Paket liefert. In diesen Fällen müssen wir Ihre Daten an diese weitergeben. Diese Unternehmen stehen sozusagen "an der Stelle" von WDIG und dürfen die Daten ausschließlich zur Lieferung des Produktes oder der Dienstleistung verwenden.
""","""
Unternehmen, die Sonderaktionen, Produkte oder Dienstleistungen anbieten
Gelegentlich bieten wir gemeinsam mit einem Partner Aktionen an, zum Beispiel Verlosungen oder kostenlose Abonnements. Wir geben Ihre Daten an die Partner weiter, wenn diese sie benötigen, um Ihnen ein Produkt zu schicken, zum Beispiel bei einem Zeitschriftenabonnement. Wir können Ihre Daten auch an diese Partner weitergeben, damit diese Ihnen weitere Sonderangebote schicken können, jedoch nur, wenn Sie uns Ihre Einwilligung dazu geben, und wir geben sie auch nur an diesen speziellen Partner weiter. Zusätzlich versendet WDIG gelegentlich E-Mail-Angebote im Auftrag von außenstehenden Partnern. In diesem Falle teilen wir Ihren Namen diesem Dritten nicht mit, sondern führen das Mailing für ihn durch. Auch hier senden wir Ihnen diese Aktionen nur zu, wenn Sie Ihre Einwilligung dazu gegeben haben.

Partner für Inhalte
Auf einigen unserer Seiten bieten wir Inhalte, die von einer Partnerwebseite (eines Drittanbieters) stammen. Zum Beispiel bietet ESPN.com Einkaufsmöglichkeiten bei Drittanbietern. In einigen Fällen erfassen die Seiten der Drittanbieter Informationen, um die Transaktionen zu erleichtern oder um die Nutzung ihrer Inhalte produktiver und effizienter zu gestalten. In diesen Fällen werden die Informationen zwischen WDIG und unseren Drittanbieter-Partnern ausgetauscht.

Dritte als Werbepartner oder Netzwerk-Werbepartner
Um den Datenschutz für unsere Gäste zu erhöhen, gestattet WDIG nur solchen Unternehmen Werbung auf unseren Seiten, die eigene Datenschutzrichtlinien haben. Wenn Sie auf eine Anzeige geklickt und die WDIG-Seiten verlassen haben, gelten unsere Richtlinien zum Datenschutz nicht mehr. Sie müssen die Datenschutzrichtlinien des Werbepartners lesen, um zu erfahren, wie Ihre persönlichen Angaben auf dessen Seite genutzt werden.
""","""
Außerdem wird ein Großteil der gewerblichen Werbung durch Drittunternehmen betreut und auf unserer Seite platziert. Diese Unternehmen heißen "Netzwerk-Werbepartner". Netzwerk-Werbepartner erfassen nicht personenbezogene Informationen, wenn Sie auf eine ihrer Bannerwerbungen klicken oder darüber streichen. Die Informationen werden automatisch erfasst, so dass Sie möglicherweise nicht merken, dass Informationen erfasst werden. Die Netzwerk-Werbepartner sammeln diese Informationen, damit sie Ihnen Anzeigen zeigen können, die für Sie relevanter und interessanter sind. Wenn Sie mehr über Netzwerk-Werbepartner lesen wollen oder wenn Sie nicht wünschen, dass Netzwerk-Werbepartner diese nicht personenbezogenen Informationen über Sie erfassen, klicken Sie bitte hier.

Kauf oder Verkauf von Unternehmen
Das Online-Geschäft befindet sich noch in einer frühen Phase und verändert und entwickelt sich rasch. Da wir bei WDIG ständig nach Wegen suchen, unsere Geschäftstätigkeit zu verbessern, ist es möglich, dass wir ein Unternehmen kaufen oder verkaufen. Wenn wir ein Unternehmen kaufen oder verkaufen, können die erfassten personenbezogenen Informationen als Bestandteil des Geschäftes mit übertragen werden. Informationen über registrierte Nutzer werden als Gesamtheit genutzt. Wenn wir jedoch ein Unternehmen kaufen, respektieren wir die Wünsche der Kunden des betreffenden Unternehmens im Hinblick auf E-Mail-Kommunikation. Wenn wir ein Unternehmen verkaufen, tun wir alles in unserer Macht Stehende, um dafür zu sorgen, dass Ihre Wünsche bezüglich E-Mail-Kommunikation respektiert werden.

Organisationen, die die Sicherheit unserer Gäste und unserer Seiten schützen helfen
Wir geben persönliche Informationen weiter, wenn dies laut Gesetz erforderlich ist (zum Beispiel auf eine gerichtliche Verfügung oder Vorladung hin), um unsere Servicebedingungen oder die Regeln von Seiten oder Spielen durchzusetzen oder um die Sicherheit unserer Gäste und Seiten zu gewährleisten.
""","""
F4 Welche Wahlmöglichkeiten habe ich in Bezug auf die Erfassung, Nutzung und Weitergabe meiner Informationen durch WDIG?

Sie können einen großen Teil unserer Seite nutzen, ohne uns personenbezogene Informationen zu geben. Wenn Sie sich bei uns registrieren oder uns personenbezogene Informationen geben, haben Sie zu dem Zeitpunkt, zu dem Ihre Informationen erfasst werden, die Möglichkeit zur Einschränkung der E-Mail-Kommunikation durch WDIG und unsere Partner. Sie können jederzeit verlangen, dass WDIG Ihnen keine weiteren E-Mails schickt, indem Sie sich entweder abmelden oder uns diesbezüglich über memberservices@help.go.com kontaktieren. Wie bereits erwähnt, besteht auch die Möglichkeit, die automatisch erfassten Informationen einzuschränken, wobei dann aber manche unserer Features nicht funktionieren.
""","""
F5 Welche Art von Sicherheit bietet WDIG?

Die Sicherheit aller personenbezogenen Daten, die mit unseren Gästen in Zusammenhang stehen, ist uns ein dringliches Anliegen. WDIG ergreift technische, vertragliche, administrative und physische Sicherheitsmaßnahmen, um die Daten aller Besucher zu schützen. Wenn Sie Kreditkarteninformationen angeben, verwenden wir die Secure-Socket-Layer-(SSL)-Verschlüsselung, um sie zu schützen. Es gibt jedoch auch einiges, was Sie selbst tun können, um ebenfalls zum Schutz Ihrer Informationen beizutragen. Geben Sie zum Beispiel nie Ihr Passwort weiter, da dieses dazu dient, auf Ihre gesamten Account-Daten zuzugreifen. Denken Sie auch daran, Ihren Account abzumelden und Ihr Browserfenster zu schließen, wenn Sie das Surfen im Web beenden, so dass andere Personen, die denselben Computer benutzen, nicht auf Ihre Daten zugreifen können.
""","""
F6 Wie kann ich auf meine Account-Daten zugreifen?

Sie können auf die personenbezogenen Daten zugreifen, die Sie uns bei der Registrierung übermittelt haben, und zwar in unserem Account-Optionen-Center unter (http://play.toontown.com). Loggen Sie sich mit Ihrem Account-Namen und dem Elternpasswort ein. Auf der Startseite finden Sie Anweisungen, wie Sie Ihr Passwort in Erfahrung bringen können, wenn Sie es einmal vergessen haben sollten.
Sie können auch Kontakt mit uns aufnehmen, indem Sie auf "Contact Us" (Kontakt) unten auf jeder beliebigen WDIG-Seite klicken und im Dropdown-Menü "Registration/Personalization" (Registrierung/Personalisierung) wählen oder direkt an memberservices@help.go.com eine E-Mail schicken. Bitte teilen Sie uns in der E-Mail Informationen mit, durch die wir Ihren Account identifizieren können, damit wir Ihnen hinsichtlich Ihrer Frage bzw. Bitte behilflich sein können.
""","""
F7 Wohin wende ich mich mit Fragen oder Problemen bezüglich dieser Datenschutzrichtlinien?
...
*Sie müssen mindestens 18 Jahre alt sein oder die Erlaubnis eines Elternteils oder Erziehungsberechtigten haben, diese Nummer zu wählen.
""",
]
PrivacyPolicyText_1K = [
"""
Datenschutzrichtlinien für Kinder:
Wir wissen um die Notwendigkeit, zusätzliche Datenschutzrichtlinien für Kinder zu bieten, die unsere Seiten besuchen.

F1 Welche Informationen erfassen WDIG-Seiten über Kinder, die 12 Jahre oder jünger sind?

Kinder können Disney.com oder andere WDIG-Seiten besuchen, sich dort Inhalte ansehen und einige Spiele spielen, ohne dass personenbezogene Informationen erfasst werden. Außerdem hosten wir von Zeit zu Zeit moderierte Chaträume, in denen keine personenbezogenen Informationen erfasst oder gepostet werden. In manchen Bereichen ist es jedoch erforderlich, personenbezogene Informationen von Kindern zu erfassen, um die Teilnahme an einer Aktivität zu ermöglichen (zum Beispiel Teilnahme an einem Wettbewerb) oder um mit unserer Community zu kommunizieren (über E-Mail oder Pinnwände).
Wir von WDIG sind der Meinung, dass es eine gute Vorgehensweise ist, von Kindern im Alter von bis zu 12 Jahren nicht mehr personenbezogene Informationen zu erfassen, als für ihre Teilnahme an unseren Online-Aktivitäten erforderlich ist. Außerdem weisen wir hiermit darauf hin, dass alle Seiten, die für 12-jährige oder jüngere Kinder gedacht sind, laut Gesetz nicht mehr Informationen als nötig erfassen dürfen.

Die einzigen personenbezogenen Informationen, die wir von Kindern erfassen, sind Vorname, E-Mail-Adresse eines Elternteils und Geburtsdatum des Kindes. Wir erfassen das Geburtsdatum, um das Alter des Gastes festzustellen. Manchmal erfassen wir auch andere persönliche Informationen, wie den Namen eines Haustieres, um es Gästen zu erleichtern, sich an ihren Login-Namen und das Passwort zu erinnern, falls sie diese einmal vergessen sollten.

Eltern haben bei uns jederzeit die Möglichkeit zu verlangen, dass die erfassten Daten über ihr Kind aus der Datenbank entfernt werden. Wenn Sie den Account Ihres Kindes deaktivieren möchten, schicken Sie bitte eine E-Mail an ms_support@help.go.com, geben Sie den Login-Namen Ihres Kindes und das Passwort an und bitten Sie um Löschung des Accounts.
""","""
F2 Wie werden die erfassten personenbezogenen Daten von WDIG verwendet und weitergegeben?

Daten, die von Gästen im Alter von bis zu 12 Jahren erfasst wurden, werden nicht für Marketing- oder Werbezwecke verwendet, weder innerhalb noch außerhalb der Seitenfamilie der Walt Disney Internet Group.
Die Daten, die von Kindern im Alter von bis zu 12 Jahren erfasst wurden, werden nur von den WDIG-Seiten für Leistungsangebote (zum Beispiel Kalender) oder für die Durchführung einiger Spiele oder Wettbewerbe genutzt. Gäste im Alter von 12 Jahren oder darunter dürfen zwar an einigen Wettbewerben teilnehmen, bei denen Daten erfasst werden, Benachrichtigung und Preise werden jedoch an die Adresse des Elternteils oder Erziehungsberechtigten geschickt, die beim Registrierungsverfahren erfasst wurde. Für die Veröffentlichung der vollständigen Namen, Altersangaben oder Bilder von Personen im Alter von 12 Jahren oder darunter ist die Einwilligung der Eltern oder Erziehungsberechtigten erforderlich. Manchmal wird eine nicht erkennbare Version des Namens eines Kindes veröffentlicht. In diesen Fällen werden die Eltern unter Umständen nicht um Erlaubnis gebeten.

Wir gestatten Kindern im Alter von 12 Jahren oder darunter nicht, an unmoderierten Chaträumen teilzunehmen.

Wir legen persönliche Informationen über Kinder offen, wenn dies laut Gesetz erforderlich ist (zum Beispiel auf eine gerichtliche Verfügung oder Vorladung hin), um unsere Servicebedingungen oder die Regeln von Seiten oder Spielen durchzusetzen oder um die Sicherheit unserer Gäste und Seiten zu gewährleisten.
""","""
F3 Informiert WDIG Eltern über die Erfassung von Informationen über Kinder im Alter von 12 Jahren oder darunter?

Wenn Kinder im Alter von 12 Jahren oder darunter sich bei uns registrieren, schicken wir einem Elternteil oder Erziehungsberechtigten immer eine Benachrichtigung per E-Mail zu. Außerdem bitten wir Eltern um ihre ausdrückliche Zustimmung, bevor wir ihren Kindern gestatten, E-Mail, Pinnwände und andere Features zu nutzen, bei denen personenbezogene Informationen im Internet veröffentlicht und an Nutzer aller Altersgruppen weitergegeben werden können.
Wir geben Eltern außerdem 48 Stunden Zeit, Registrierungen rückgängig zu machen, die Kinder vornehmen, um an Spielen und Wettbewerben teilzunehmen. Wenn wir keine gegenteilige Rückantwort erhalten, gehen wir davon aus, dass die Eltern der Registrierung des Kindes zustimmen. Wenn sich ein Kind registriert hat, darf es an allen künftigen Spielen und Wettbewerben teilnehmen, für die eine Registrierung notwendig ist, und die Eltern werden nicht nochmals benachrichtigt. In diesem Fall verwenden wir die erfassten Informationen nur dazu, Eltern zu benachrichtigen, wenn ein Kind bei einem Spiel oder Wettbewerb gewonnen hat. Wir verwenden diese Informationen nicht für andere Zwecke.
""","""
F4 Wie können Eltern auf Informationen über ihre Kinder zugreifen?

Es gibt drei Möglichkeiten, die Informationen zu überprüfen, die über Kinder im Alter von 12 Jahren oder darunter erfasst wurden.

Wenn Eltern ihren Kindern den Zugang zu interaktiven Features wie Pinnwänden gewähren, müssen sie einen Familienaccount einrichten. Ist ein Familienaccount eingerichtet, kann der Hauptinhaber des Accounts die personenbezogenen Informationen aller Familienmitglieder, einschließlich des Kindes, bearbeiten. Sie können auf diese Informationen zugreifen, indem Sie sich auf der Seite Your Account (Eigener Account) in Ihren Familienaccount einloggen.

Wenn Sie nicht bereits Mitglied einer der WDIG-Seiten sind, können Sie die personenbezogenen Informationen Ihres Kindes bearbeiten, indem Sie sich in den Account Ihres Kindes auf der Homepage Account Options (Account-Optionen) einloggen. Sie brauchen dazu den Account-Namen und das Passwort Ihres Kindes. Auf der Homepage Your Account (Eigener Account) finden Sie eine Anleitung, wie Sie das Passwort Ihres Kindes in Erfahrung bringen können, falls Ihr Kind es einmal vergessen haben sollte.
Sie können sich auch an den Kundendienst wenden, um die Informationen einzusehen, die von Ihrem oder über Ihr Kind erfasst wurden. Schicken Sie dazu eine E-Mail an ms_support@help.go.com. Wenn Sie noch keinen Familienaccount eingerichtet haben, benötigen Sie den Benutzernamen und das Passwort Ihres Kindes. Geben Sie in der E-Mail bitte Angaben wie den Account-Namen des Kindes oder die E-Mail-Adresse des Elternteils an, die uns helfen, den Account Ihres Kindes zu identifizieren, so dass wir Ihnen bei Ihrem Anliegen behilflich sein können.
""","""
F5 Welche Art von Sicherheit bietet WDIG?

Die Sicherheit aller personenbezogenen Daten, die mit unseren Gästen in Zusammenhang stehen, ist uns ein dringliches Anliegen. WDIG ergreift technische, vertragliche, administrative und physische Sicherheitsmaßnahmen, um die Informationen aller Besucher zu schützen. Wenn Sie Kreditkarteninformationen angeben, verwenden wir die Secure-Socket-Layer-(SSL)-Verschlüsselung, um sie zu schützen. Sie gibt jedoch auch einiges, was Sie selbst tun können, um ebenfalls zum Schutz Ihrer Informationen beizutragen. Geben Sie zum Beispiel nie Ihr Passwort weiter, da dieses dazu dient, auf Ihre gesamten Account-Daten zuzugreifen. Denken Sie auch daran, Ihren Account abzumelden und Ihr Browserfenster zu schließen, wenn Sie das Surfen im Web beenden, so dass andere Personen, die denselben Computer benutzen, nicht auf Ihre Daten zugreifen können.
""","""
F6 Wie informiert WDIG die Eltern, wenn sich diese Datenschutzrichtlinien ändern?

Falls WDIG diese Datenschutzrichtlinien ändert, werden die Eltern diesbezüglich per E-Mail benachrichtigt.
...
Als Sie sich auf unserer Seite registrierten, haben wir uns verpflichtet, Ihre persönlichen Angaben sicher und mit großem Respekt zu behandeln und Sie auch genauestens darüber zu informieren, wie wir Ihre persönlichen Daten erfassen und nutzen. Im Rahmen dieser Verpflichtung möchten wir Sie über wichtige Veränderungen informieren, die wir bei unseren allgemeinen Datenschutzrichtlinien vornehmen. Diese Veränderungen gelten sowohl für persönliche Daten, die Sie in der Vergangenheit angegeben haben, als auch für persönliche Daten, die Sie in Zukunft angeben werden. Es gibt eine Seite „Häufig gestellte Fragen", auf der Sie eine Zusammenfassung der wichtigsten Änderungen finden. Wir ändern auch von Zeit zu Zeit unsere Datenschutzrichtlinien für Kinder. Wir empfehlen Ihnen, die aktualisierten Datenschutzrichtlinien vollständig zu lesen.

Sie können auf unterschiedliche Weise die aktualisierten allgemeinen Datenschutzrichtlinien akzeptieren: durch eine E-Mail, beim Einloggen oder über Links zu den Datenschutzrichtlinien (wie hier) auf einer Seite unserer Seitenfamilie. Alternativ können Sie die aktualisierten Datenschutzrichtlinien als Bestandteil eines Zahlungsvorganges auf einer Seite unserer Seitenfamilie akzeptieren. Wenn Sie sich dafür entscheiden, die aktualisierten Datenschutzrichtlinien nicht zu akzeptieren, werden Ihre Daten weiterhin nach den vorherigen Richtlinien behandelt. Sie werden jedoch nur begrenzten Zugang zu bestimmten Leistungen auf unseren Seiten haben und entsprechend Ihren bestehenden Kontaktvorgaben werden Sie weiterhin E-Mails von uns erhalten.

Bitte beachten Sie, dass für alle Gäste, die sich nach dem 6. November 2003 registrieren, automatisch die aktualisierten Datenschutzrichtlinien gelten und kein weiterer Handlungsbedarf besteht.


Wenn Sie schon Mitglied sind und die Änderungen akzeptieren möchten, wählen Sie bitte DGG.ACCEPT (AKZEPTIEREN).
""","""
Seit 75 Jahren kann die Walt Disney Company stolz auf die Beziehungen verweisen, die sie zu ihren Gästen entwickelt hat. Wir von der Walt Disney Internet Group folgen dieser Tradition, setzen uns für den Schutz Ihrer Privatsphäre ein und behandeln alle persönlichen Informationen, die wir von Ihnen erhalten, mit Sorgfalt und Respekt. Die nachfolgenden Informationen sollen Ihre Fragen bezüglich unserer Datenschutzrichtlinien beantworten.

Datenschutzrichtlinien für Kinder:

Wir wissen um die Notwendigkeit, zusätzliche Datenschutzrichtlinien für Kinder zu bieten, die unsere Seiten besuchen. Bitte hier klicken, um unsere Schutzmaßnahmen für Kinder unter 13 Jahre zu lesen.


F1 Für welche Informationen gelten diese Datenschutzrichtlinien?
F2 Welche personenbezogenen Informationen erfassen wir über unsere Gäste?
F3 Wie werden Ihre personenbezogenen Informationen genutzt und weitergegeben?
F4 Welche Wahlmöglichkeiten haben Sie bezüglich der Erfassung, Nutzung und Weitergabe Ihrer personenbezogenen Daten?
F5 Welche Sicherheitsmaßnahmen ergreifen wir, um Ihre personenbezogenen Informationen zu schützen?
F6 Wie können Sie Ihre Kontaktdaten aktualisieren und Ausschließungsoptionen ändern?
F7 Wie können Sie zu diesen Datenschutzrichtlinien Fragen stellen oder uns Anmerkungen schicken?
F8 Wie erfahren Sie von einer Änderung dieser Datenschutzrichtlinien?
""","""
F1 Für welche Informationen gelten diese Datenschutzrichtlinien?
A1 Außer in Fällen wie unter A2 und A6 beschrieben gelten diese Datenschutzrichtlinien nur für personenbezogene Informationen, die auf Webseiten erfasst wurden, die diese Datenschutzrichtlinien enthalten. Sie gelten nicht für andere von der Walt Disney Family of Companies mit anderen Mitteln erfasste Informationen. Diese Datenschutzrichtlinien gelten für die Nutzung und Weitergabe personenbezogener Informationen, die zum oder nach dem Datum der Webseitenveröffentlichung dieser Datenschutzrichtlinien erfasst wurden. Bei Gästen, die sich vor dem Datum der Webseitenveröffentlichung dieser Datenschutzrichtlinien angemeldet haben, wenden wir diese Datenschutzrichtlinien auf mit diesem Account verbundene personenbezogene Informationen nur dann an, wenn der Gast diese Datenschutzrichtlinien akzeptiert. Hat der Gast diese Richtlinien akzeptiert, so finden die Datenschutzrichtlinien auch Anwendung auf personenbezogene Informationen, die vor dem Datum der Webseitenveröffentlichung dieser Datenschutzrichtlinien erfasst wurden. In ähnlicher Weise wenden wir diese Datenschutzrichtlinien auf personenbezogene Informationen an, die bei Transaktionen ohne Anmeldung (wie unter A3 beschrieben) vor dem Datum der Webseitenveröffentlichung dieser Datenschutzrichtlinien erfasst wurden, jedoch nur, wenn der Gast die Datenschutzrichtlinien akzeptiert.
""","""
In diesen Datenschutzrichtlinien steht "Walt Disney Family of Companies" für die Walt Disney Company und alle ihre Tochter- und Zweiggesellschaften wie ABC und ESPN, die im Allgemeinen ihre Produkte und Leistungen nicht unter dem Markennamen "Disney" anbieten, sowie Unternehmen, die im Allgemeinen ihre Produkte und Leistungen unter dem Markennamen "Disney" anbieten. (Manchmal wird auf unseren Webseiten die Walt Disney Family of Companies auch als "Walt Disney family of companies" bezeichnet). Die Walt Disney Internet Group gehört zur Walt Disney Family of Companies und wird in diesen Datenschutzrichtlinien mit "wir", "uns" und "unser" bezeichnet.
""","""
Entsprechend der Tradition der Walt Disney Company bezeichnen wir Kunden der Walt Disney Family of Companies als "Gäste". Wenn in diesen Datenschutzrichtlinien der Begriff "personenbezogene Informationen" verwendet wird, dann meinen wir damit Informationen/Daten, die eine bestimmte Person betreffen, wie zum Beispiel Name, Postanschrift, E-Mail-Adresse und Telefonnummer der Person. Wenn andere Informationen, wie zum Beispiel Vorlieben für bestimmte Verbraucherprodukte oder Anzahl der Kinder, direkt mit personenbezogenen Informationen verbunden werden, so werden diese anderen Informationen im Rahmen dieser Datenschutzrichtlinien ebenfalls zu personenbezogenen Informationen. Personenbezogene Informationen werden in diesen Datenschutzrichtlinien zuweilen auch als "persönliche Informationen" oder "persönliche Daten" bezeichnet. Diese Datenschutzrichtlinien unterliegen allen anwendbaren Gesetzen.
""","""
F2 Welche personenbezogenen Informationen erfassen wir über unsere Gäste?
A2 Wir erfassen unterschiedliche Arten personenbezogener Informationen über unsere Gäste.

Informationen, die Sie angeben

Viele der personenbezogenen Informationen, die wir erhalten, kommen direkt von Gästen, die daran interessiert sind, verschiedene Produkte und Leistungen von uns zu erhalten. Normalerweise gehören dazu Name, Postanschrift, E-Mail-Adresse und Telefonnummer des Gastes. Wir können auch andere Informationen erfassen, wie Geschlecht, Alter, Anzahl der Kinder und persönliche Interessen, die mit den personenbezogenen Informationen verbunden werden können. Wenn jemand von uns Produkte oder Leistungen erwirbt, zeichnen wir zum Beispiel Kreditkarteninformationen, die Art der bestellten oder erworbenen Leistung oder des Produktes und das Bestell- oder Kaufdatum auf. Wir erfassen persönliche Daten, wenn jemand sich auf unseren Webseiten registriert, einloggt oder diese besucht und auch wenn jemand an Aktivitäten auf unseren Webseiten teilnimmt, zum Beispiel an Verlosungen, Wettbewerben, Spielen und Aktionsangeboten.
""","""
Automatisch erfasste Informationen

Wir erfassen automatisch Informationen, um unsere Seiten für Sie interessanter und nutzbringender zu gestalten. Wenn Sie zum Beispiel eine unserer Seiten besuchen, erfassen wir Ihre IP-Adresse. Eine IP-Adresse steht oft für die Stelle, von der aus Sie ins Internet gelangen, zum Beispiel Ihren ISP (Internet Service Provider), Ihr Unternehmen oder Ihre Universität. Für sich allein ist die IP-Adresse nicht personenbezogen. Zuweilen nutzen wir IP-Adressen, um Informationen über die Häufigkeit zu sammeln, mit der unsere Gäste verschiedene Bereiche unserer Seiten besuchen. Wir können diese Informationen mit personenbezogenen Informationen verbinden.

Unsere Webseiten verwenden auch Cookies. Cookies sind Informationen, die eine Webseite an Ihren Computer schickt, während Sie die Webseite betrachten. Wir und andere Internet-Unternehmen verwenden Cookies für sehr unterschiedliche Zwecke. Wenn Sie zum Beispiel nach dem Einloggen auf eine unserer Seiten zurückkehren, liefern Cookies Informationen an die Seite, so dass die Seite sich an Sie erinnert. Sie können sich von Ihrem Computer warnen lassen, wenn ein Cookie geschickt wird. Sie können auch alle Cookies deaktivieren. Dies stellen Sie über Ihren Browser ein (zum Beispiel Netscape Navigator oder Internet Explorer). Jeder Browser ist ein wenig anders. Schauen Sie daher im Hilfe-Menü Ihres Browsers nach, wie man Cookie-Optionen richtig einstellt. Wenn Sie Cookies deaktivieren (nicht zulassen), dann können Sie viele Features, die Ihren Aufenthalt im Web effizienter gestalten, wie zum Beispiel die oben erwähnten, nicht nutzen und manche unserer Serviceangebote werden nicht richtig funktionieren.
""","""
Unsere Webseiten nutzen für die Rückverfolgung verschiedene technische Methoden, zum Beispiel Web Beacons. Web Beacons sind kleine Datenstücke, die in Bilder auf den Seiten von Websites eingebettet sind. Wir nutzen diese technischen Methoden auch, um Verkehrsmuster auf unseren Webseiten zu analysieren, wie zum Beispiel die Häufigkeit, mit der unsere Benutzer verschiedene Bereiche unserer Webseiten aufsuchen. Zu diesen technischen Methoden kann die Übertragung von Information gehören, entweder direkt an uns oder an Dritte, die von uns autorisiert wurden, für uns Informationen zu erfassen. Wir nutzen diese technischen Methoden auch in HTML-E-Mails, die wir unseren Gästen schicken, um festzustellen, ob unsere Gäste diese E-Mails geöffnet und/oder die darin enthaltenen Links angeklickt haben. Die Informationen aus der Nutzung dieser technischen Methoden können in einer Form erfasst werden, die personenbezogen ist.

Viele Anzeigen werden auf unseren Seiten von Dritten verwaltet und eingestellt. Diese Unternehmen werden "Netzwerk-Werbepartner" genannt. Netzwerk-Werbepartner, die Anzeigen auf unsere Webseiten platzieren, verwenden möglicherweise ebenfalls Cookies und Web Beacons um nicht personenbezogene Informationen zu erfassen, wenn Sie Ihren Cursor über eines der Werbebanner führen oder es anklicken. Sie merken möglicherweise nicht, dass diese Informationen erfasst werden. In einigen Fällen haben wir Zugriff auf Informationen der von Netzwerk-Werbepartnern auf unseren Seiten verwendeten Cookies oder Web Beacons, und diese Informationen können es uns möglichen, andere von Ihnen besuchte Seiten, die ebenfalls mit dem Netzwerk-Werbepartner Verbindung haben, zu identifizieren. Wenn Sie auf eine Anzeige geklickt und unsere Webseiten verlassen haben, gelten im Übrigen unsere Datenschutzrichtlinien nicht mehr und Sie müssen die Datenschutzrichtlinien des Werbetreibenden lesen, um zu erfahren, wie mit Ihren persönlichen Daten auf dessen Website verfahren wird.
""","""
Informationen, die wir von anderen erhalten

Wir können personenbezogene Informationen, die wir direkt von unseren Gästen erhalten haben, durch andere Informationen ergänzen, die wir von Dritten und anderen Mitgliedern der Walt Disney Family of Companies erhalten. Außerdem können wir uns Informationen über Personen beschaffen, die noch keine Benutzer unserer Webseiten oder Gäste der Walt Disney Family of Companies sind. Wenn wir Informationen, die wir von Dritten oder anderen Mitgliedern der Walt Disney Family of Companies erhalten, mit personenbezogenen Informationen verbinden, die wir erfasst haben und die diesen Datenschutzrichtlinien unterliegen, so werden wir die erhaltenen Informationen ebenso behandeln wie die von uns selbst gesammelten und diese Informationen nicht an Dritte weitergeben, außer in den von diesen Datenschutzrichtlinien gestatteten Fällen.
""","""
F3 Wie werden Ihre personenbezogenen Informationen genutzt und weitergegeben?
A3 Wie weiter unten genauer beschrieben kann die Walt Disney Family of Companies Ihre personenbezogenen Informationen auf unterschiedliche Weise nutzen. Dazu gehört, Ihnen Werbematerialien zu schicken oder Ihre Informationen an Dritte weiterzugeben, damit diese Ihnen Werbematerialien schicken können. (Unter "Werbematerialien" verstehen wir hier Informationen, die direkt die Nutzung unserer Webseiten oder den Erwerb von Produkten oder Leistungen fördern.) Wie unter A4 beschrieben, können Sie bestimmte Nutzungen Ihrer persönlichen Informationen ausschließen.
""","""
Disney Family of Companies, Lizenznehmer und Co-Branding-Partner

Im Rahmen dieser Datenschutzrichtlinien erfasste personenbezogene Informationen werden innerhalb der Walt Disney Family of Companies für viele Zwecke ausgetauscht und verwendet. Zum Beispiel kann die Walt Disney Family of Companies Ihre persönlichen Informationen nutzen, um Ihnen Werbematerial zu Produkten und Leistungen (einschließlich Sonderangeboten und Aktionen) zu schicken, die entweder von der Walt Disney Family of Companies oder von Dritten angeboten werden. Diese Werbematerialien können Ihnen per Post, E-Mail oder über andere Wege zugesandt werden. Wie in A4 beschrieben können Sie den Erhalt solcher Mitteilungen ausschließen. Bitte denken Sie jedoch daran, dass bei einem Kauf oder einer Anforderung von Produkten oder Leistungen von der Walt Disney Family of Companies Werbematerialien die Lieferung solcher Produkte oder Leistungen begleiten können. In diesen Fällen bezeichnen wir das Versenden von Werbematerialien als "Fulfillment-Nutzung" Ihrer persönlichen Informationen. Da diese Werbematerialien Produkte oder Leistungen begleiten, die Sie angefordert haben, gilt Ihre Ausschließung einzelner Disney-Unternehmen und der Walt Disney Family of Companies laut A4 nicht für diese Fulfillment-Nutzungen.
""","""
Die Walt Disney Family of Companies kann Ihre persönlichen Informationen auch für andere Zwecke verwenden als nur für den Versand von Werbematerialien. (Wir bezeichnen alle Nutzungsarten Ihrer persönlichen Informationen, die nicht den Versand von Werbematerialien einschließen, als "operative Nutzung".) Zum Beispiel können wir Ihre Informationen verwenden, um von Ihnen angeforderte Transaktionen auszuführen (zum Beispiel den Erwerb von auf unseren Webseiten angebotenen Produkten oder Leistungen) oder um Ihnen verwaltungstechnische Mitteilungen zu Ihrem Account bei uns oder zu Features unserer Webseiten zu schicken, zum Beispiel auch über künftige Änderungen dieser Datenschutzrichtlinien. Ein weiteres Beispiel für operative Nutzung ist die Weitergabe Ihrer persönlichen Informationen an die telefonische Buchungszentrale von Walt Disney World, so dass die Mitarbeiter der Buchungszentrale sofort auf Ihre Anfragen oder Anforderungen antworten können, ohne Ihre Daten ein zweites Mal von Ihnen erfragen zu müssen. Da diese Nutzungen Ihrer persönlichen Daten keinen Versand von Werbematerial an Sie einschließen, gilt Ihre Ausschließung einzelner Disney-Unternehmen und der Walt Disney Family of Companies laut A4 nicht für diese operativen Nutzungsarten.
""","""
Neben der Nutzung innerhalb der Walt Disney Family of Companies kann die Walt Disney Family of Companies Ihre persönlichen Informationen auch an Unternehmen weitergeben, die Produkte und/oder Leistungen unter Markennamen der Walt Disney Family of Companies anbieten. Diese Unternehmen werden "Lizenznehmer(in)" genannt. Zum Beispiel wäre ein Unternehmen, das Bücher der Marke "Disney" publiziert und verkauft, ein Lizenznehmer in diesem Sinne. Die Walt Disney Family of Companies kann Ihre persönlichen Informationen auch an Unternehmen weitergeben, die Co-Branding-Produkte und/oder –Leistungen anbieten, die Markennamen der Walt Disney Family of Companies verwenden. Diese Unternehmen werden "Co-Branding-Partner" genannt. Beispielsweise ist die Disney-Visacard ein Co-Branding-Produkt in Zusammenarbeit mit der Bank, die diese Kreditkarte ausgibt. Wenn die Walt Disney Family of Companies persönliche Informationen an Dritte weitergibt, die als Lizenznehmer oder Co-Branding-Partner fungieren, so dürfen diese laut Vertrag die persönlichen Informationen nicht für Marketing- oder Werbezwecke verwenden, die keinen Bezug zu einem lizenzierten oder Co-Branding-Produkt oder einem solchen Service haben. Um Ihre Privatsphäre noch besser zu schützen, unterliegt die Nutzung persönlicher Informationen durch Lizenznehmer und Co-Branding-Partner, die diese Informationen im Rahmen dieser Datenschutzrichtlinien erhalten haben, denselben Ausschließungsrechten (und Einschränkungen dieser Rechte), die für die Nutzung persönlicher Informationen durch Mitglieder der Walt Disney Family of Companies laut A4 gelten.
""","""
Sie können Transaktionen (wie zum Beispiel die Bezahlung von Produkten oder Leistungen) abwickeln, ohne sich auf unseren Webseiten zu registrieren oder einzuloggen. Diese Transaktionen können mit uns oder anderen Mitgliedern der Walt Disney Family of Companies abgewickelt werden. (Alle Transaktionen, die Sie abwickeln, ohne sich auf unseren Webseiten zu registrieren oder einzuloggen nennen wir "unregistrierte Transaktionen".) Ein Beispiel für eine unregistrierte Transaktion wäre, wenn Sie Artikel von DisneyStore.com erwerben, ohne sich auf der entsprechenden Seite zu registrieren oder einzuloggen. Wenn Sie unregistrierte Transaktionen abwickeln, so stehen Ihnen die unter A4 beschriebenen Ausschließungs-Optionen nicht zur Verfügung, aber Ihre Daten werden nicht an Dritte weitergegeben und auch nicht von Mitgliedern der Walt Disney Family of Companies - mit Ausnahme des an Ihrer Transaktion beteiligten Mitglieds - dazu verwendet, Ihnen Werbematerialien zuzusenden, es sei denn, dies ist durch andere Regelungen dieser Datenschutzrichtlinien gesondert gestattet.
""","""
Schließlich kann die Walt Disney Family of Companies Ihre personenbezogenen Informationen in nicht personenbezogene verwandeln, entweder durch die Kombination mit Informationen über andere Einzelpersonen (eine Vermengung Ihrer Informationen mit Informationen über andere Personen) oder durch Entfernen charakteristischer Merkmale (zum Beispiel Ihres Namens), durch die die Informationen auf Sie bezogen sind (Entpersonalisierung Ihrer Informationen). Dem Wesen dieser Informationen entsprechend gibt es nach diesen Datenschutzrichtlinien keine Einschränkungen für das Recht der Walt Disney Family of Companies, Ihre personenbezogenen Informationen zu vermengen oder zu entpersonalisieren, und die Walt Disney Family of Companies kann die daraus entstehenden nicht personenbezogenen Informationen auf jede beliebige Weise nutzen und/oder an Dritte weitergeben.
""","""
Drittunternehmen, die Aktionen, Produkte oder Dienstleistungen anbieten

Entsprechend Ihren Ausschließungsoptionen (siehe A4 unten) kann die Walt Disney Family of Companies Ihre persönlichen Informationen an ausgewählte Dritte weitergeben, so dass diese Ihnen Werbematerialien über Waren und Leistungen (einschließlich Sonderangebote und Aktionen) aus ihrem Angebot schicken können. (Diese Art der Weitergabe nennen wir "Werbeweitergabe" oder Weitergabe zu "Werbezwecken".) Bei einer Weitergabe Ihrer Informationen zu Werbezwecken ist die Walt Disney Family of Companies darum bemüht, nur Unternehmen mit gutem Ruf auszuwählen, die hochwertige Produkte und Leistungen anbieten. Außerdem gibt die Walt Disney Family of Companies Ihre E-Mail-Adresse nicht zu Werbezwecken an Dritte weiter, es sei denn, Sie stimmen im Verlauf Ihrer Teilnahme an einer gesponserten Aktivität (wie unten beschrieben) einer solchen Weitergabe zu. Wenn die Walt Disney Family of Companies Ihre persönlichen Informationen unter irgendeinem in diesem Abschnitt "Drittunternehmen, die Aktionen, Produkte oder Dienstleistungen anbieten" beschriebenen Umstand weitergibt, unterliegen Ihre persönlichen Informationen dort dauerhaft den Verfahrensweisen der Informationsnutzung und -weitergabe dieses Dritten, und der Dritte wird durch diese Datenschutzrichtlinien in Bezug auf seine Nutzung und künftige Weitergabe Ihrer persönlichen Informationen in keiner Weise eingeschränkt.
""","""
Zusätzlich zur Werbeweitergabe, die von Ihrer Ausschließungsentscheidung laut A4 abhängig ist, kann die Walt Disney Family of Companies Ihre Informationen auch weitergeben, wenn Sie sich an bestimmten Aktivitäten auf unseren Seiten beteiligen, die von Dritten unterstützt werden, wie zum Beispiel beim Kauf von Produkten oder Dienstleistungen, die von Dritten angeboten werden, oder bei der Entscheidung, Informationen oder Mitteilungen von Dritten zu erhalten, oder bei der Entscheidung, an Wettbewerben, Verlosungen, Spielen oder anderen Programmen teilzunehmen, die vollständig oder zum Teil von Dritten gesponsert werden. Die Walt Disney Family of Companies kann Ihre personenbezogenen Informationen auch weitergeben, wenn Sie auf Werbematerialien der Walt Disney Family of Companies reagieren und Dritten gestatten, Ihre personenbezogenen Informationen für Zwecke wie den Versand weiterer Werbematerialien an Sie, die Lieferung eines Produktes oder einer Dienstleistung an Sie oder die Einbeziehung Ihrer Person in Wettbewerbe, Verlosungen oder Spiele zu verwenden. (Wir bezeichnen diese Aktivitäten und Anforderungen insgesamt als "gesponserte Aktivitäten".) Wenn Sie an gesponserten Aktivitäten teilnehmen, werden Sie entweder aufgefordert oder gebeten zuzustimmen, dass der Sponsor oder Geschäftspartner Ihre personenbezogenen Informationen in Übereinstimmung mit den Datenschutzrichtlinien des betreffenden Sponsors oder Geschäftspartners verwenden darf (in einigen Fällen einschließlich Ihrer E-Mail-Adresse). Da Sie diesem speziellen Fall der Weitergabe Ihrer personenbezogenen Informationen zugestimmt haben, findet die Ausschließungsoption für "Dritte", wie unter A4 untenstehend beschrieben, keine Anwendung.
""","""
Unternehmen, die Kommunikation und Transaktionen mit Ihnen erleichtern

Manchmal beauftragt die Walt Disney Family of Companies Unternehmen mit der Lieferung von Produkten oder Leistungen, wie zum Beispiel ein Transportunternehmen, das ein Paket liefert, oder ein Unternehmen, das die Preiseinlösung einer Verlosung umsetzen hilft. In diesen Fällen ist es notwendig,  Ihre Informationen diesen Unternehmen mitzuteilen. Manchmal arbeitet die Walt Disney Family of Companies auch mit anderen Unternehmen zusammen, die entweder bei der Erfassung Ihrer Informationen mitwirken oder mit Ihnen kommunizieren. Ihre Ausschließungsoptionen (wie unter A4 beschrieben) gelten nicht für die Weitergabe Ihrer persönlichen Informationen durch die Walt Disney Family of Companies an diese Unternehmen. Allerdings ist es diesen Unternehmen nur für die in diesem Abschnitt genannten Zwecke oder wie gesetzlich vorgeschrieben gestattet, Ihre Informationen zu sammeln, zu empfangen und zu nutzen, wenn nicht nach anderen Klauseln dieser Datenschutzrichtlinien anderes gesondert zulässig ist.
""","""
Unternehmen, denen Sie bereits gestattet haben, Ihre Informationen einzuholen

Unter bestimmten Umständen ist es möglich, dass Ihre Geschäftsbeziehung zu Dritten diese Dritten dazu autorisiert hat, Ihre persönlichen Daten von der Walt Disney Family of Companies einzuholen und diese Informationen in Übereinstimmung mit den Datenschutzrichtlinien und -verfahrensweisen dieser dritten Partei zu nutzen. Beispielsweise haben Sie vielleicht durch die Nutzung eines Online-Shopping-Dienstes (wie zum Beispiel Shopping-Dienste, die von Internetportalen angeboten werden und die Benutzer des Portals an Dritte als Händler verweisen) diesen Shopping-Dienst autorisiert, von den am Service beteiligten Dritten als Händler (zum Beispiel die Walt Disney Family of Companies) Informationen über die von Ihnen über den Shopping-Dienst durchgeführten Einkäufe einzuholen. Unter diesen Umständen haben die von Ihnen gewählten Ausschließungsoptionen laut A4 keine Gültigkeit für die Weitergabe Ihrer persönlichen Informationen durch die Walt Disney Family of Companies. Die Walt Disney Family of Companies wird an solche Unternehmen jedoch nur diejenigen Informationen weitergeben, für die Sie die Genehmigung erteilt haben (es sei denn, etwas anderes ist durch diese Datenschutzrichtlinien gesondert gestattet). Im oben angeführten Beispiel würde der Shopping-Dienst nur Informationen in Bezug auf solche Einkäufe erhalten, die Sie über diesen Shopping-Dienst bei der Walt Disney Family of Companies getätigt haben. Er würde keine anderen Informationen, die Sie betreffen, erhalten, es sei denn, eine zusätzliche Weitergabe Ihrer persönlichen Informationen ist durch eine andere Klausel dieser Datenschutzrichtlinien gesondert gestattet.
""","""
Kauf oder Verkauf von Unternehmen

Von Zeit zu Zeit ist es möglich, dass wir ein Unternehmen kaufen oder ein oder mehrere unserer Unternehmen verkaufen, und Ihre personenbezogenen Informationen können als Bestandteil des Kaufs oder Verkaufs mit übertragen werden. Wenn wir ein Unternehmen kaufen, werden die personenbezogenen Informationen, die wir mit diesem Unternehmen erhalten, entsprechend den vorliegenden Datenschutzrichtlinien behandelt, soweit dies möglich und zulässig ist. Wenn wir ein Unternehmen verkaufen, werden wir in den Verkaufsvertrag Klauseln einbinden, die vom Käufer verlangen, Ihre personenbezogenen Informationen in der durch diese Datenschutzrichtlinien geforderten Weise zu behandeln (einschließlich etwaiger Änderungen dieser Datenschutzrichtlinien). Angesichts dieses Schutzes berühren Ihre gewählten Ausschließungsoptionen laut A4 nicht unser Recht, unter diesen Umständen Ihre Informationen auf einen Käufer zu übertragen. Die Richtlinien dieses Abschnittes gelten auch für den Fall, dass ein oder mehrere Unternehmen eines beliebigen anderen Mitglieds der Walt Disney Family of Companies verkauft werden und persönliche Informationen, die diesen Datenschutzrichtlinien unterliegen, auf den Käufer dieser Unternehmen übertragen werden.
...
Unabhängig von den von Ihnen gewählten Ausschließungsoptionen laut A4 wird die Walt Disney Family of Companies persönliche Informationen offen legen, wenn sie guten Glaubens ist, dass eine solche Offenlegung (a) gesetzlich erforderlich ist (zum Beispiel auf eine gerichtliche Verfügung oder Vorladung hin) oder (b) dazu beiträgt, unsere Nutzungsbedingungen durchzusetzen, Regeln für Wettbewerbe, Verlosungen, Sonderaktionen und/oder Spiele durchzusetzen, Ihre Sicherheit zu schützen, einschließlich der Sicherheit Ihres Eigentums, und/oder die Sicherheit unserer Webseiten, der Walt Disney Family of Companies und/oder Dritter zu schützen, einschließlich der Sicherheit von Eigentum der Walt Disney Family of Companies oder Dritter.
""","""
F4 Welche Wahlmöglichkeiten haben Sie bezüglich der Erfassung, Nutzung und Weitergabe Ihrer personenbezogenen Daten?
A4 Bezüglich persönlicher Informationen, die Sie im Rahmen dieser Datenschutzrichtlinien angegeben haben, stehen Ihnen drei verschiedene Ausschließungsoptionen zur Verfügung. Mittels dieser Ausschließungsoptionen geben oder verweigern Sie uns Ihre Einwilligung zur Nutzung Ihrer persönlichen Informationen für die in diesen Ausschließungsoptionen angegebenen Zwecke. Auf einigen unserer Webseiten werden möglicherweise nicht alle drei der unten beschriebenen Ausschließungsoptionen angezeigt. Wir versichern Ihnen jedoch, dass in den Fällen, in denen Ihnen eine dieser Ausschließungsoptionen auf einer Webseite nicht zur Verfügung steht, die auf dieser Seite von Ihnen erfassten persönlichen Informationen nicht für den in dieser Ausschließungsoption angegebenen Zweck verwendet werden. Sie können Ihre Ausschließungsentscheidung auf unterschiedliche Weise treffen: (a) während des Registriervorgangs auf unseren Webseiten, (b) nach der Registrierung, indem Sie sich auf unseren Seiten einloggen, unsere Datenschutzlinks anklicken, zum Gästeservice-Center gehen (auf manchen Seiten heißt dies "Member Service" [Mitgliederservice] oder "Preferences" [Einstellungen]) und die Anleitung zum Ausschließen von Optionen befolgen, und (c) wie unter A6 beschrieben. Für jede dieser Ausschließungsoptionen gelten die Ausnahmen, die weiter unten in diesem Abschnitt (A4) beschrieben werden.
""","""
Sie haben die folgenden drei Ausschließungsoptionen:

Dritte: Sie können entscheiden, dass Sie keine Werbematerialien von Dritten erhalten möchten. Wenn Sie diese Ausschließungsoption nicht wählen, kann die Walt Disney Family of Companies Ihre persönlichen Informationen weitergeben, so dass Dritte Ihnen Werbematerialien zusenden können. Ihre Ausschließungsoptionen für Dritte gelten speziell für die jeweiligen Webseiten, auf denen Sie diese Option wählen. Wenn Sie also jegliche Verwendung Ihrer persönlichen Daten, die die Ausschließungsoption für "Dritte" beinhaltet, ausschließen wollen, müssen Sie immer diese Ausschließungsoption wählen, und zwar auf jeder unserer Webseiten, auf der Sie sich entweder registrieren oder einloggen oder das Gästeservice-Center besuchen. Bitte beachten Sie, dass diese Ausschließungsoption für "Dritte" nicht für die unter A3 beschriebenen Lizenznehmer und Co-Branding-Partner gilt.
""","""
Walt Disney Family of Companies: Sie können entscheiden, dass Sie keine Werbematerialien von der Walt Disney Family of Companies oder ihren Lizenznehmern oder Co-Branding-Partnern wie unter A3 beschrieben erhalten möchten. Diese Ausschließungsoption findet sich auf jeder unserer Webseiten. Der Einfachheit halber übernehmen wir Ihre Entscheidung bezüglich dieser Ausschließungsoption für "Walt Disney Family of Companies", wenn Sie sie auf einer unserer Webseiten treffen, als Aktualisierung aller vorherigen Entscheidungen, die Sie in Bezug auf diese Ausschließungsoption möglicherweise getroffen haben. Wenn Sie daher Ihre Ausschließungsoption für "Walt Disney Family of Companies" ändern wollen, können Sie diese Änderung vornehmen, indem Sie das Gästeservice-Center auf einer beliebigen unserer Webseiten besuchen. Ihre Entscheidung für die Ausschließungsoption für "Walt Disney Family of Companies" setzt jedoch nicht Ihr gegebenes Einverständnis außer Kraft, Werbematerial von einem bestimmten Mitglied der Walt Disney Family of Companies zu erhalten. Wie im folgenden Abschnitt beschrieben wird, geben Sie dieses Einverständnis, wenn Sie das Gästeservice-Center der Webseite für ein bestimmtes Mitglied der Walt Disney Family of Companies besuchen und sich dafür entschieden, den Empfang von Werbematerialien dieses speziellen Mitglieds nicht auszuschließen.
""","""
Einzelne Disney-Unternehmen: Sie können bestimmen, dass Sie keine Werbematerialien direkt von einem speziellen Mitglied der Walt Disney Family of Companies erhalten möchten. Dafür müssen Sie das Gästeservice-Center der Webseite für dieses spezielle Mitglied besuchen und die Zusendung von Werbematerialien von diesem speziellen Mitglied ausschließen. Wenn Sie jedoch dabei nicht ebenfalls die Zusendung von Werbematerialien der "Walt Disney Family of Companies" ausschließen wie im oben stehenden Abschnitt beschrieben, ist es möglich, dass Sie trotzdem Werbematerialien dieses speziellen Mitglieds der Walt Disney Family of Companies erhalten.
""","""
Bitte beachten Sie, dass alle Ausschließungsentscheidungen, die Sie treffen, in folgenden Situationen keine Anwendung finden: wenn (a) Sie Informationen von einem Mitglied der Walt Disney Family of Companies vor oder gleichzeitig mit der Ausschließung speziell angefordert haben oder später anfordern, (b) die Walt Disney Family of Companies Ihre persönlichen Informationen entweder für "operative Nutzung" oder "Fulfillment-Nutzungen" (wie unter A3 beschrieben) verwendet, (c) Sie sich vorher, gleichzeitig oder nachher an unregistrierten Transaktionen oder gesponserten Aktivitäten (wie unter A3 beschrieben) beteiligen bzw. beteiligt haben oder (d) die Walt Disney Family of Companies Ihre persönlichen Informationen im Rahmen der Regelungen unter A3 im Hinblick auf "Unternehmen, die Kommunikation und Transaktionen mit Ihnen erleichtern", "Unternehmen, denen Sie bereits gestattet haben, Ihre Informationen einzuholen", "Dritte als Werbepartner oder Netzwerk-Werbepartner", "Kauf oder Verkauf von Unternehmen" oder "Gesetzlich vorgeschriebene Offenlegung und Offenlegung zum Schutz der Sicherheit unserer Seiten, der Walt Disney Family of Companies und anderer" weitergibt.
""","""
Wenn Sie Ihre Ausschließung nicht bei der Registrierung oder beim ersten Einloggen auf unsere Webseiten ausführen, so kann es bis zu neunzig (90) Tage dauern, bis Ihre gewählten Ausschließungsoptionen voll wirksam werden. Unsere Systeme benötigen Zeit für die Aktualisierung, und Werbesendungen, für die vor Ihrer Ausschließung Ihre persönlichen Daten genutzt wurden, wurden möglicherweise schon bearbeitet. Es ist daher möglich, dass Sie bis zu neunzig (90) Tage später noch Werbematerialien von der Walt Disney Family of Companies auf der Grundlage der persönlichen Informationen erhalten, die Sie im Rahmen dieser Datenschutzrichtlinien angegeben haben. Aus ähnlichen Gründen ist es möglich, dass Ihre persönlichen Informationen noch bis zu neunzig (90) Tage später zu Werbezwecken an Dritte weitergegeben werden.
""","""
F5 Welche Sicherheitsmaßnahmen ergreifen wir, um Ihre personenbezogenen Informationen zu schützen?
A5 Die Sicherheit und Vertraulichkeit Ihrer Informationen ist uns überaus wichtig. Wir haben technische, administrative und physische Sicherheitsmaßnahmen ergriffen, um die Informationen aller Gäste vor unberechtigtem Zugriff und missbräuchlicher Nutzung zu schützen. Von Zeit zu Zeit überprüfen wir unsere Sicherheitsverfahren, um geeignete neue Technologien und Methoden zu ermitteln. Bitte beachten Sie jedoch, dass es trotz unserer größten Bemühungen keine Sicherheitsmaßnahmen gibt, die perfekt oder absolut sicher sind.
""","""
F6 Wie können Sie Ihre Kontaktdaten aktualisieren und Ausschließungsoptionen ändern?
A6 Der Zugriff auf Ihre Kontaktdaten, die Sie bei der Anmeldung angegeben haben (das heißt Ihre Postanschrift, E-Mail-Adresse oder andere Informationen, die es uns direkt ermöglichen, mit Ihnen Kontakt aufzunehmen), und die Änderung Ihrer gewählten Ausschließungsoptionen ist über einen Besuch in den Mitgliederservice-Centers auf unseren Webseiten möglich. Klicken Sie einfach auf diesen Link http://register.go.com/go/memberservices/home oder gehen Sie zu den Gästeservice-Centers auf unseren Webseiten und loggen Sie sich dann mit Mitgliedsname und Passwort ein. Auf der Startseite des oben stehenden Links finden Sie Anweisungen, wie Sie Ihr Passwort in Erfahrung bringen, wenn Sie es einmal vergessen haben sollten. Wenn Sie Ihr Passwort vergessen haben sollten, können Sie auch eine E-Mail an ms_support@help.go.com schreiben. Bitte geben Sie in der E-Mail Daten an, die es uns ermöglichen, Ihren Account zu identifizieren, damit wir Ihnen bei Ihrem Anliegen helfen können. Wir können Ihnen auch Gelegenheit geben, Ihre Kontaktinformationen zu aktualisieren und/oder Ihre gewählten Ausschließungsoptionen zu ändern, indem wir Ihnen eine E-Mail oder eine andere Mitteilung schicken, in der wir um Antwort bitten. Schließlich können Sie bestimmte E-Mail-Mitteilungen abbestellen, indem Sie auf die entsprechenden Links in diesen E-Mails klicken.
""","""
F7 Wie können Sie zu diesen Datenschutzrichtlinien Fragen stellen oder uns Anmerkungen schicken?
...
Sie können sicher sein, dass persönliche Informationen, die Sie in Mitteilungen an die oben genannte E-Mail- oder Postanschrift angeben, nicht dafür verwendet werden, Ihnen Werbematerialien zuzusenden, wenn Sie nicht ausdrücklich darum bitten.
""","""
F8 Wie erfahren Sie von einer Änderung dieser Datenschutzrichtlinien?
A8 Wir können diese Datenschutzrichtlinien jederzeit ändern. Wenn wir die Art und Weise, wie wir Ihre persönlichen Informationen erfassen, nutzen und/oder weitergeben, grundsätzlich ändern, benachrichtigen wir Sie durch eine E-Mail an die E-Mail-Adresse, die Sie uns zuletzt angegeben haben, und wir platzieren außerdem an auffälliger Stelle einen Hinweis über die Änderungen auf die Webseiten, die diesen Datenschutzrichtlinien unterliegen. Alle grundsätzlichen Änderungen dieser Datenschutzrichtlinien treten entweder dreißig (30) Kalendertage nach unserem Versand einer E-Mail-Benachrichtigung an Sie in Kraft oder dreißig (30) Kalendertage nach unserem Einstellen des Hinweises über Änderungen auf den Webseiten, die diesen Datenschutzrichtlinien unterliegen. Bitte beachten Sie, dass Sie stets selbst dafür verantwortlich sind, Ihre persönlichen Informationen zu aktualisieren und uns Ihre aktuelle E-Mail-Adresse anzugeben. Falls die letzte von Ihnen angegebene E-Mail-Adresse nicht gültig ist oder Ihnen aus anderen Gründen die oben beschriebene Benachrichtigung nicht zugestellt werden kann, so stellt dessen ungeachtet unser Versand der E-Mail, die diese Benachrichtigung enthält, eine gültige Benachrichtigung über die in der Nachricht beschriebenen Änderungen dar. In jedem Fall können Änderungen dieser Datenschutzrichtlinien sich schon vor unserer Änderungsbenachrichtigung an Sie auf unsere Nutzung Ihrer persönlichen Informationen, die Sie vor den Änderungen angegeben haben, auswirken. Wenn Sie Änderungen unserer Nutzung Ihrer Informationen nicht wünschen, müssen Sie uns vor dem Datum des Inkrafttretens der Änderungen darüber Informieren, dass Sie Ihren Account bei uns deaktivieren möchten.
Die Walt Disney Internet Group ist Lizenznehmerin des TRUSTe Privacy Program. Wenn Sie der Meinung sind, dass WDIG auf Ihre Anfrage nicht oder nicht ausreichend geantwortet hat, wenden Sie sich bitte an TRUSTe unter http://www.truste.org/users/users_watchdog.html.
...
Seit mehr als 75 Jahren blickt die Walt Disney Company stolz auf die Beziehungen, die sie zu ihren Gästen entwickelt hat. Wir von der Walt Disney Internet Group folgen dieser Tradition, setzen uns für den Schutz Ihrer Privatsphäre ein und behandeln alle persönlichen Informationen, die wir von Ihnen erhalten, mit Sorgfalt und Respekt. Die nachfolgenden Informationen zu den Datenschutzrichtlinien für Kinder sollen Ihre Fragen bezüglich unserer Datenschutzrichtlinien für Kinder unter 13 Jahren beantworten.

Wir wissen um die Notwendigkeit, zusätzliche Datenschutzrichtlinien für Kinder zu bieten, die diese Seiten besuchen, auf denen diese Datenschutzrichtlinien für Kinder veröffentlicht sind. Wir erklären diese zusätzlichen Schutzmaßnahmen hier in den Datenschutzrichtlinien für Kinder. Der Einfachheit halber verwenden wir in diesen Datenschutzrichtlinien für Kinder Begriffe, die in unseren allgemeinen Datenschutzrichtlinien erklärt sind.

Das Gesetz zum Online-Datenschutz für Kinder (Children's Online Privacy Protection Act - COPPA) schreibt vor, dass wir Eltern und Erziehungsberechtigte darüber informieren müssen, wie wir persönliche Daten von Kindern unter 13 Jahren erfassen, nutzen und offen legen, und dass wir die Genehmigung der Eltern oder Erziehungsberechtigten einholen müssen, wenn Kinder unter 13 Jahren bestimmte Features unserer Webseiten nutzen wollen. Nachfolgend wird erklärt, wie wir im Falle dieser "Kinder" verfahren. Wenn wir den Begriff "Eltern(teil)" verwenden, so umfasst dies auch Erziehungsberechtigte .
""","""
F1 Welche persönlichen Informationen erfassen wir über Kinder?
F2 Wie geschieht unsere Nutzung und Weitergabe von persönlichen Informationen, die wir über Kinder erfasst haben?
F3 Wie benachrichtigen wir Eltern über das Erfassen persönlicher Informationen über ihre Kinder und wie holen wir ihre Erlaubnis ein?
F4 Wie können Eltern auf persönliche Informationen über ihre Kinder zugreifen und diese ändern oder löschen?
F5 Wie benachrichtigen wir Eltern, wenn unsere Datenschutzrichtlinien für Kinder sich ändern?
F6 An wen können sich Gäste mit Fragen oder Problemen bezüglich unserer Datenschutzrichtlinien für Kinder wenden?
""","""
F1 Welche persönlichen Informationen erfassen wir über Kinder?
A1 Kinder können Disney.com und andere WDIG-Webseiten besuchen, sich Inhalte ansehen und viele Spiele spielen, ohne dass persönliche Informationen erfasst werden. Wir erfassen keine persönlichen Informationen über Kinder, solange sie sich nicht auf WDIG-Seiten registrieren. Normalerweise registrieren sich Kinder, um an Verlosungen oder Wettbewerben oder einer speziellen Aktivität teilzunehmen. Die einzigen Informationen, die wir von Kindern beim Registriervorgang erfassen, sind Vorname des Kindes, E-Mail-Adresse der Eltern, Geburtsdatum des Kindes, Mitgliedsname und Passwort. Wir erfassen das Geburtsdatum, um das Alter unserer Gäste, einschließlich der Kinder, festzustellen. Wir erfassen während des Registriervorganges keine anderen personenbezogenen Informationen von Kindern. Wir erfassen auch die E-Mail-Adresse eines Kindes über einen Elternteil, um dem Kind E-Mails bezüglich seines Abonnements zu schicken. Zum Beispiel würden wir auf Anforderung eines Elternteils des Kindes Disney's Blast Gazette direkt an das Kind schicken. Bitte beachten Sie, dass es für alle Webseiten, die für Kinder unter 13 Jahren gedacht sind, verboten ist, die Teilnahme eines Kindes an einer Online-Aktivität davon abhängig zu machen, dass das Kind mehr persönliche Informationen liefert als unbedingt notwendig.
""","""
Wir erfassen persönliche Informationen von Eltern, damit Kinder bestimmte Features auf unseren Webseiten und im Rahmen unserer Abonnementprodukte für Kinder nutzen können, wie zum Beispiel bei Disney's Blast und Disney's Toontown Online (Einzelheiten siehe A3). Dazu gehören Features wie das Chatten mit Instant Messages (zum Beispiel Geheime Freunde bei Disney's Toontown Online), das Versenden von E-Mails, das Posten an Pinnwänden, Interaktionen mit Brieffreunden und ähnliche Aktivitäten. Im Rahmen einer Teilnahme eines Kindes an solchen Aktivitäten ist es möglich, dass das Kind uns auch zusätzliche Informationen über sich liefert, beispielsweise die Inhalte seiner Chats oder Pinnwand-Postings. Wenn ein Elternteil uns gestattet, persönliche Informationen über sein Kind zu erfassen, können wir bestimmte automatisch erfasste Informationen (siehe Abschnitt "Automatisch erfasste Informationen" unter A2 unserer allgemeinen Datenschutzrichtlinien) mit diesen persönlichen Informationen verbinden.
""","""
F2 Wie geschieht unsere Nutzung und Weitergabe von personenbezogenen Informationen, die wir über Kinder erfasst haben?
A2 Wenn ein Kind sich für eine Verlosung oder einen Wettbewerb registriert, nutzen wir die E-Mail-Adresse des Elternteils, um den Elternteil über den Anmeldewunsch des Kindes zu informieren (wie unter A3 beschrieben). Um Mitteilungen an ein Kind in Bezug auf ein spezielles Produkt (zum Beispiel Disney's Blast) zu personalisieren, verwenden wir den Vornamen des Kindes zusammen mit dem Nachnamen des Elternteils und einer E-Mail-Adresse, die der Elternteil bei der Anmeldung für dieses spezielle Produkt angegeben hat. Wir können die E-Mail-Adresse eines Kindes über den Elternteil erfassen, um dem Kind einen Newsletter zu schicken, wie zum Beispiel Disney's Blast Gazette. Außerdem können persönliche Informationen in Bezug auf ein Kind im Rahmen der Teilnahme des Kindes an bestimmten interaktiven Features, zum Beispiel Pinnwänden und Brieffreundschaftsdiensten, bekannt gegeben werden.
""","""
Wir geben keine Informationen über ein Kind an Mitglieder der Walt Disney Family of Companies oder an Dritte weiter, wenn dies nicht unbedingt notwendig, d.h. gesetzlich erforderlich ist (wie zum Beispiel auf eine gerichtliche Verfügung oder Vorladung hin), um unsere Servicebedingungen oder Webseiten- oder Spielregeln durchzusetzen oder um die Sicherheit unserer Gäste und unserer Webseiten zu schützen.
""","""
F3 Wie benachrichtigen wir Eltern über das Erfassen persönlicher Informationen über ihre Kinder und wie holen wir ihre Erlaubnis ein?
A3 Wir schicken Eltern eine E-Mail, wenn sich ihr Kind registriert und an einer Verlosung oder einem Wettbewerb teilnimmt, und wir geben den Eltern 48 Stunden Zeit, die Registrierung ihres Kindes und seine Teilnahme an der Verlosung oder dem Wettbewerb abzulehnen. Wenn der Elternteil die Registrierung und Teilnahme des Kindes nicht gestattet, löschen wir die Informationen des Kindes aus unserer Datenbank. Wenn wir von dem Elternteil keine Rückmeldung erhalten, gehen wir davon aus, dass das Kind sich anmelden und an der Verlosung oder dem Wettbewerb teilnehmen darf. Hat der Elternteil dem Kind die Registrierung gestattet, kann das Kind an späteren auf Registrierung basierenden Verlosungen oder Wettbewerben teilnehmen, ohne dass der Elternteil erneut informiert wird. Gewinnt ein Kind eine Verlosung oder einen Wettbewerb, so informieren wir den Elternteil über die Eltern-E-Mail-Adresse, die uns beim Anmeldevorgang mitgeteilt wurde, und fordern vom Elternteil die Postanschrift an, damit der Preis ausgeliefert werden kann. Wir können den Vornamen des Gewinners, den ersten Buchstaben des Nachnamens, den Wohnort und den Bundesstaat bzw. das Land auf unseren Webseiten veröffentlichen.
""","""
Bevor wir einem Kind gestatten, ein Feature unserer Webseiten zu nutzen, das dazu führen könnte, dass die Daten des Kindes Dritten im Internet bekannt werden könnten, fordern wir den Namen und Kreditkartendaten eines Elternteils zur Bestätigung an, dass der Elternteil die Erlaubnis zur Teilnahme des Kindes an solchen Features gegeben hat. Die Kreditkarte wird nur dann belastet, wenn der Elternteil sich für einen Abonnementservice anmeldet und uns die Belastung der Kreditkarte gestattet hat. Ansonsten werden die Kreditkarteninformationen für die Echtzeit-Überprüfung genutzt, um zu bestätigen, dass ein Erwachsener die Teilnahme des Kindes genehmigt. Die Kreditkarteninformationen werden sicher archiviert und von uns als Beweis dafür aufbewahrt, dass wir die elterliche Zustimmung erhalten haben.
""","""
F4 Wie können Eltern auf personenbezogene Informationen über ihre Kinder zugreifen und diese ändern oder löschen?
A4 Eltern können jederzeit die Erlaubnis für eine weitere Erfassung persönlicher Informationen über ihr Kind verweigern und verlangen, dass alle persönlichen Informationen, die wir bisher gesammelt haben, aus unseren Aufzeichnungen gelöscht werden. Wir nutzen zwei Methoden, die es Eltern gestatten, auf personenbezogene Informationen, die wir über ihre Kindern erfasst haben, zuzugreifen und diese zu verändern oder zu löschen.
""","""
Eltern können auf die persönlichen Informationen ihres Kindes zugreifen und diese ändern oder löschen, indem sie sich in den Account des Kindes auf der Mitgliederservice-Homepage unter http://register.go.com/go/memberservices/home einloggen. Dazu ist der Mitgliedsname und das Passwort des Kindes erforderlich. Auf der Homepage "Eigener Account" findet sich eine Anleitung, wie man ein Passwort in Erfahrung bringt, wenn das Kind es einmal vergessen haben sollte.
""","""
Eltern können sich an unsere Kundendienstabteilung wenden, um auf die persönlichen Informationen, die wir über ihr Kind erfasst haben, zuzugreifen, sie zu ändern oder zu löschen. Schicken Sie dazu eine E-Mail an ms_support@help.go.com und nennen Sie darin den Mitgliedsnamen des Kindes und die Eltern-E-Mail-Adresse, damit wir Ihnen bei Ihrem Anliegen besser helfen können.
""","""
F5 Wie benachrichtigen wir Eltern, wenn unsere Datenschutzrichtlinien für Kinder sich ändern?
A5 Wir können unsere Datenschutzrichtlinien für Kinder jederzeit ändern. Wir werden Eltern per E-Mail über alle grundlegenden Änderungen informieren, die die Art und Weise betreffen, wie wir persönliche Informationen von Kindern zu erfassen, zu nutzen und/oder weiterzugeben beabsichtigen. Bitte beachten Sie als Eltern, dass Sie Ihre persönlichen Informationen immer auf dem aktuellen Stand halten, damit wir gültige E-Mail-Adressen haben. Grundlegende Änderungen unserer Datenschutzrichtlinien für Kinder werden wir nur in Übereinstimmung mit geltendem Recht durchführen. Dazu zählen auch alle anzuwendenden Vorschriften des COPPA (Gesetz zum Online-Datenschutz für Kinder), die elterliche Zustimmung erfordern.
""","""
F6 An wen können sich Gäste mit Fragen oder Problemen bezüglich unserer Datenschutzrichtlinien für Kinder wenden?
F6 Wenn Sie weitere Hilfe benötigen, schicken Sie bitte eine E-Mail mit Ihren Fragen oder Anmerkungen an ms_support@help.go.com oder schreiben Sie an:
  ...
  Mail Code 7716
  Burbank, CA 91521-7716, USA
  Sie können uns auch unter ++1-(877) 466-6669 anrufen. (Personen unter 18 Jahren müssen die Erlaubnis eines Elternteils oder Erziehungsberechtigen haben, diese Nummer anzurufen.)
...
CreateAccountScreenSubmit = "Absenden"
...
SpeedChatStaticText = {
    ...
    1551 : "Ich werde einen Köder einsetzen.",
    ...
    1556 : "Nimm zuerst den schwächsten Bot.",
    1557 : "Nimm zuerst den stärksten Bot.",
    1558 : "Spar deine starken Gags auf.",
    1559 : "Setze Volldröhnen nicht bei geköderten Bots ein.",
    ...
    10003 : "Stimm im Nu! Stimm für Kuh!",
    10004 : "Alles Banane! Stimm für Affe!",
    10005 : "Sei honigsüß! Stimm für Bär!",
    10006 : "Setz dich ein! Stimm für Schwein!",
    10007 : "Stimm für Ziege - und mach die Fliege!",
...
CustomSCStrings = {
    ...
    7020 : "Einer macht’s vor und alle äffen es nach.",
    ...
    7090 : "Na, da fress ich ‘ne Palme.",
    7100 : "Mir rasen tausend Affen durch den Kopf.",
    7110 : "Nicht für einen Wald voll Affen.",
    7120 : "Nichts hören.",
    7130 : "Nichts sehen.",
    7140 : "Nichts sagen.",
    ...
    7180 : "Affenmäßig gut!",
    7190 : "Ich könnte Bäume ausreißen!",
    7200 : "Jetzt aber Banane!",
    7210 : "Hier wachsen die Bäume in den Himmel!",
    7220 : "Wer hat die Kokosnuss geklaut??",
    7230 : "Das bringt mich ja echt auf die Palme.",
    7230 : "Du siehst wohl den Wald vor lauter Bäumen nicht!",
    7240 : "Jelly Beans wachsen eben nicht auf Bäumen!",
